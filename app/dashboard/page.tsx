...
export default function Dashboard() {
  ...
  const myPosts =
    useQuery(api.posts.listByAuthor, user ? { authorId: user.id } : "skip") ??
    [];
  ...
  const handleDelete = async (id: any) => {
    if (confirm("Are you sure you want to delete this post?")) {
      await deletePost({ id, authorId: user.id });
    }
  };
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="bg-neutral-50 border-b border-neutral-200">
                  <th className="px-6 py-4 font-medium text-neutral-500 text-sm uppercase tracking-wider">
                    Title
                  </th>
                  <th className="px-6 py-4 font-medium text-neutral-500 text-sm uppercase tracking-wider">
                    Status
                  ...
                  <th className="px-6 py-4 font-medium text-neutral-500 text-sm uppercase tracking-wider text-right">
                    Actions
                  </th>
                </tr>
              </thead>
